...
const DATA_VERSION = 22; // 改这个数字强制刷新所有用户的缓存
...
const defaultApps = [
  ...
  {
    "id": 51,
    "slug": "主题商店-超高清墙纸动态壁纸大全",
    "name": "主题商店-超高清墙纸动态壁纸大全",
    "desc": "玩转你的动态壁纸！ 超全动态壁纸，动态屏保任你选择 高清壁纸才更能彰显你独特的气质 让你的屏幕获得高质量的动画，让你的设备吸引艳羡的目光！ 你还能一键创建个人收藏，保存自选壁纸！ 将它们保存在“收藏”类目下。 动动手指，获得你喜欢的壁纸，随心随时定制锁屏。 \t 特色：制定个性日历壁纸，无需打开手机桌面，在手机锁屏界面即可浏览本月日历及本月节假日  注意：目前仅支持在iPhone设置为锁定屏幕时，按压展示动态壁纸效果；设置主屏幕暂不支持动态效果仍为静态壁纸；",
    "category": "Utilities",
    "price": "免费",
    "originalPrice": null,
    "rating": 4.7,
  ...
  {
    "id": 52,
    "slug": "小组件-桌面灵动岛主题壁纸小插件",
    "name": "小组件-桌面灵动岛主题壁纸小插件",
    "desc": "Art Widget 是一款专为iOS14用户设计的个性化桌面小组件APP，可以让你将个性时尚的小组件直接添加到你的桌面上，打造属于你的独一无二的手机屏幕。  -海量模板：无数设计精美的小组件模板可供选择 -操作简单，快速运行程序、一键添加个性小组件 -所有运行iOS 14的手机和ipad设备都支持",
    "category": "Utilities",
    "price": "免费",
    "originalPrice": null,
    "rating": 4.7,
  ...
  {
    "id": 53,
    "slug": "top-widgets-万能小组件手机桌面主题美化工具",
    "name": "Top Widgets⁺ - 万能小组件手机桌面主题美化工具",
    "desc": "▶ App Store 人气推荐 ◀  ▶ 百万用户一致好评 ◀  ▶ 桌面美化与效率工具首选 ◀  为 OS 26 带来前所未有的桌面体验。基于全新系统特性，融入液态玻璃视觉、立体3D景深壁纸及可自定义的动态封面，打造出层次丰富、多维沉浸的交互空间。每一次点亮屏幕，都是一场视觉与艺术的盛宴。  超过 5000+ 专业原创设计师，不断注入新鲜灵感。从空间景深到液态光影，从动态壁纸到创意主题，让你的桌面不仅仅是工具，更是风格、心情与个性的表达。  【OS 26 沉浸式视觉升级】  空间景深壁纸：智能分层与动态交互，让时间与元素自然融合，展现逼真的立体感与空间感。  液态玻璃主题：如流动的水晶般透",
    "category": "Utilities",
    "price": "免费",
    "originalPrice": null,
    "rating": 4.8,
  ...
  },
  {
    ...
    "slug": "快捷指令",
    "name": "快捷指令",
    "desc": "Siri 捷径可配合应用快速完成各种任务。您只需轻点一下，或让 Siri 帮您完成。“捷径”应用可为您喜爱的应用创建包括多个步骤的个性化捷径。您可以从“捷径中心”中数以百计的示例开始，或通过拖放操作创建自己的捷径。  “捷径”中包含了 300 多个内建操作，可与众多您喜爱的应用配合使用，包括“通讯录”、“日历”、“地图”、“音乐”、“照片”、“相机”、“提醒事项”、Safari 浏览器和“健康”，以及任何支持 Siri 捷径的应用。  使用“捷径”应用，您可以： * 直接让 Siri 获取回家的路线，发送预计到达时间以及开始听新闻 * 添加致电他人的主屏幕图标 * 制作动画 GIF * 从 S",
    "category": "Productivity",
    "price": "免费",
    "originalPrice": null,
    "rating": 4.4,
  ...
  {
    "id": 55,
    "slug": "快捷指令库-充电动画-捷径库-小组件",
    "name": "快捷指令库-充电动画,捷径库&小组件",
    "desc": "快捷指令大师专注于发现和分享捷径、您可以一键体验各类热门有趣的快捷指令 快捷指令包含了 多类直接可以使用的捷径，能够完成众多独特的功能。 并且还按照功能进行划分分类“图书”、“娱乐”、“工具”、“社交”、“生活”、“效率”、“音乐”，丰富您的日常生活，操作简单编辑，轻松设置即可实现各种捷径。  详细介绍 随心更改图标，字铃声，自定义图标、铃声让你个性十足 带密码锁的图标，更好的保护你的隐私 更换应用名字，让你的手机桌面更有个性！  连续会员订阅说明： -订阅周期：一个月或一年 -付款：用户付款记入iTunes账户 -取消订阅：如需取消订阅，请在当前订阅到期24小时以前，手动到在Apple ID",
    "category": "Utilities",
    "price": "免费",
    "originalPrice": null,
    "rating": 4.5,
  ...
  },
  {
    ...
    "slug": "易买工品",
    "name": "易买工品",
    "desc": "---工业品便利网上店，让小企业购买FA自动化零配件更方便---； 1.品种齐全：370万+产品，覆盖FA工厂自动化零配件； 2.闪电发货：27000+产品当日发货； 3.只卖正品：所有产品正规渠道或者厂家进货，确保正品； 4.明码标价：1个起卖，1块钱也开票。  易买工品APP是一款工业品采购移动商城，我们致力于成为一家中国人打造的世界级MRO专业人员，让小企业购买耗材更方便，1个起卖，还可以开具增值税发票，为您打造简单、可靠、愉悦的采购体验。具有商品搜索/浏览、商品购买、在线支付/货到付款、订单查询、物流跟踪、在线客服等功能，是您手机里的自动化耗材市场。  ---使用者反馈--- 1.端子",
    "category": "Shopping",
    "price": "免费",
    "originalPrice": null,
    "rating": 4.4,
